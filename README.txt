...
Evidemment, sur le plan technique, cette base de données a essuyé les platres et certains choix auraient été différents aujourd'hui (notamment il aurait pu être imaginé un couplage avec MySQL pour stocker les données et les requêtes et gagner en puissance)
